...
date: 2024-03-17
description: "Gentle reminders when using the \pkg{here} package for your RStudio projects"
categories:
 - r
 - packages
 - here
...
Let's suppose my directory is located in the Project folder. The `here` package is going to look for the `.Rproj` file and establish the root directory there.
...
here::i_am("data/summaryDat.rds")
# Each script should contain a call to here::i_am("file/path") at the top. 
```
